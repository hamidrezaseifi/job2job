...
INSERT INTO `j2j_candidate` VALUES (9,'','','',NULL,'hamidrezaseifi@gmail.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2017-04-10 00:00:00','2017-04-12 00:00:00');
...
INSERT INTO `j2j_distance` VALUES ('10 km',1),('15 km',1),('20 km',1),('5 km',1),('50 km',1);
...
CREATE TABLE `j2j_jobpositionskill` (
  ...
  KEY `FK_JOBPOSTIONSKILL_SKILLS_idx` (`skillid`),
  ...
  CONSTRAINT `FK_JOBPOSTIONSKILL_SKILLS` FOREIGN KEY (`skillid`) REFERENCES `j2j_skills` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `j2j_languages` VALUES ('de',1,'Deutsch','/web/images/flag_de.png','/de',1,'2016-09-16 13:07:42','2016-09-16 13:07:42'),('en',2,'English','/web/images/flag_us.png','/en',1,'2016-09-16 13:07:42','2016-09-16 13:07:42'),('fr',3,'French','/web/images/flag_fr.png','/fr',1,'2016-11-04 16:32:21','2016-11-04 16:32:21'),('nl',4,'Dutch','/web/images/flag_nd.png','/nd',0,'2016-11-04 16:51:13','2016-11-04 16:51:13');
...
-- Dump completed on 2017-04-13 17:20:13
