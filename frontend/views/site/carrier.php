...
<div class="branch-container">
	...
	<div class="anim-image-header" style="background-image: url(<?=Yii::getAlias('@web')?>/web/images/carrier.jpg); background-size: 100% 190%;">
	...
	<div class="branch-content">
	    ...
	    <div style="margin-top: 20px">
    		...
    		<div class="width50 pad-left20"><p>Einengende Vorschriften und strikte Anwesenheitszeiten gibt es bei uns nicht. Dafür <strong>Flexibilität und Freiraum.</strong> Immerhin weiß jeder von uns selbst am besten, wie er produktiv und möglichst stressfrei arbeiten kann. </p></div>
			<div class="clear"></div>
		</div>		
