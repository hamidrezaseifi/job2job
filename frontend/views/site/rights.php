...
<div class="branch-container">
	...
	<div class="branch-content">
        ...
        <div style="font-size: 30px; font-weight: bold; color: #1a3156">Information über Ihre Rechte</div>
        <br>
        <p>
        Auf dieser Seite informieren wir Sie gemäß Art. 246 EGBGB noch einmal gesondert über Ihre Rechte. Der letzte Passus („Unsere Rechte“) beschreibt, welche Rechte sich Job2Job GmbH vorbehält.
        </p>
        ...
        <ol>
            ...
            <li><strong>Ist der Vertragstext nach Vertragsschluss bei Job2Job GmbH gespeichert und für mich zugänglich?</strong><br>
            Ihr Vertrag mit Job2Job GmbH besteht aus folgenden Elementen:
            <ul style="list-style-type: disc; margin-left: 30px;">
                <li>Einverständniserklärung auf der „Registrierungs“-Seite</li>
                <li>Nutzungsbedingungen</li>
                <li>Job2Job GmbH Datenschutzerklärung</li>
            </ul>
            Sie können alles jederzeit einsehen, speichern oder ausdrucken, indem Sie strg-s bzw. strg-p drücken.
            </li>
            <li><strong>Was kostet der personalisierte Nutzerbereich?</strong><br>
