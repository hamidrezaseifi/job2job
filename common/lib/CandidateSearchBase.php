...
class CandidateSearchBase extends CandidateBase
{
     ...
     * @return ActiveDataProvider
     */
    public function searchList($useridList)
    {
    	$query = CandidateBase::find();
    	...
    	$query->filterWhere(['in' , 'userid' , $useridList]);
