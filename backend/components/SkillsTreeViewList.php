...
class SkillsTreeViewList extends Widget
{
	public $viewid;
	public $viewclass;
	public $viewstyle;
	...
	public function run() {
		...
		$body .= '<thead><tr><th>' . $searchModel->attributeLabels()['title'] . '</th><th style="width: 80px;">Status</th><th style="width: 100px;"></th></tr></thead>';
	...
	private function renderParent($parentid , $level , $disabled)
	{
		...
		foreach ($dataProvider as $model)
		{
			...
			$body .= $this->render('skilltreelist/body' , [ 'model' => $model , 'level' => $level ,
